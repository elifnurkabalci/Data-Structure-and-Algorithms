...
public class Account{
    ...
    private ArrayList<Account> blokedAccounts;
    ...
    public Account(String username, String birthdate, String location, String accountid){
        ...
        this.blokedAccounts = new ArrayList<>();
    ...
    public void viewPosts(Account anotherAccount, Account loggAccount){
        if(anotherAccount.posts.isEmpty()){
    ...
    public void viewInteractionsByself(){
        ...
        for(int i=0; i<posts.size(); i++){
            ...
            if(!posts.get(i).getcomment().isEmpty()){
                System.out.println("The post has " + posts.get(i).getcomment().size() + " comment(s)...");
                for(int j=0; j<posts.get(i).getcomment().size(); j++){
                    System.out.println("Comment " + posts.get(i).getcomment().size() + " : (" + posts.get(i).getcomment().get(j).getAccountid() + ") said " + posts.get(i).getcomment().get(j).getComments());
                }
            }
            else{
    ...
    public void block_user(Account account, Account logged_account){
        if(logged_account.getAccountid() == getAccountid()){
            ...
            for(int i=0; i<account.posts.size(); i++){
                for(int j=0; j<account.posts.get(i).getLikes().size(); j++){
                    if(account.posts.get(i).getLikes().get(j).getAccountid() == logged_account.getAccountid()){
                        ArrayList<Like> likes = account.posts.get(i).getLikes();
            ...
            for(int i=0; i<account.posts.size(); i++){
                for(int j=0; j<account.posts.get(i).getcomment().size(); j++){
                    if(account.posts.get(i).getcomment().get(j).getAccountid() == logged_account.getAccountid()){
                        String temo = account.posts.get(i).getcomment().get(j).getPostid();
    ...
    public void removeComment(String postid, Account account){
        ...
        for(int i=0; i<account.posts.size(); i++){
            for(int j=0; j<account.posts.get(i).getcomment().size(); j++){
                if(account.posts.get(i).getcomment().get(j).getAccountid() == getAccountid()){
                    account.posts.get(i).getcomment().remove(j);
                    temp =0;
                }
            }
            if(temp ==1){
    ...
    public void unfollow(Account account, Account logged_Account){
        if(logged_Account.getAccountid() == getAccountid()){
            String a = "You followed " + account.getUsername();
            actions.add(a);
